    ...
    ngx_str_t *value)
{
    ...
    if (n == 0) {
        val = (ngx_http_script_value_code_t*)ngx_http_script_start_code(cf->pool, &lcf->codes,
    ...
    complex = (ngx_http_script_complex_value_code_t*)ngx_http_script_start_code(cf->pool, &lcf->codes,
    ...
    uintptr_t data)
{
    ...
    rlcf = (ndk_http_rewrite_loc_conf_t*)ngx_http_get_module_loc_conf(r, ngx_http_rewrite_module);
